...
('Alberto', 'Paz', 'alberto.paz@example.com', '$2a$12$EF93EIWPQepjHWzdHPGM5eOaXOdzY.Rv4kpiy3iyezKaeUnZGKjT.', '1988-11-03'),
('Christian', 'Araujo', 'christian.araujo@example.com', '$2a$17$DqqhxVilWVpbmBuM4eHXSuO8Hdakr.n7tTS9EJYpq1TYRmkNyH906', '1993-02-26'),
('Milton', 'Mendes', 'milton.mendes@example.com', '$2a$17$yUpU5f0ry07zJAwbovesGeeDM1oY7hMOAysqThHdMfunfeg0iJozW', '1986-12-10'),
('Roberto', 'Carlos', 'roberto.carlos@example.com', '$2a$17$Kf5DigqpdZQPVKrcxK1Gnu4U3PnKNHUIYuqtZbKdVZMmSvF2oWnlm', '1997-08-05'),
('João', 'Das Coves', 'joao.das.coves@example.com', '$2a$17$CupR9DidHNSlQiJlSF5x6.HXtEF0WW1iYVLU4epunrVJC7FZEtNmm', '1989-03-21');